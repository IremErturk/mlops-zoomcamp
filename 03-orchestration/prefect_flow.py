...
def add_features(df_train, df_val):
    print(f"Train Data:{df_train.shape}, Validation_Data:{df_val.shape}")
...
def main(
    train_path: str = "./../artifacts/data/green_tripdata_2021-01.parquet",
    val_path: str = "./../artifacts/data/green_tripdata_2021-02.parquet",
):
